...
**Editor's note**: in the original presentation the Zen of Nim was given at the end (and without numbering).
...
and structured programming makes much easier for a proof engine to help with this.
...
"hey, every graph that is constructed is disjoint", but depending on the body of your function,
